...
var getRelativePath = (from, to) =>
  import_node_path.default.relative(
    import_node_path.default.dirname(from || ''),
    import_node_path.default.dirname(to || '')
  ) || './'
...
var formatExportTypeFileName = (file) =>
  (0, import_node_path2.basename)(file.replace('.ts', ''))
      ...
      if (err) {
        ...
        try {
          ...
          const classNameKeys = extractClassNameKeys(
            (0, import_postcss_js.objectify)(
              (0, import_postcss.parse)(css.localStyle)
            ),
            toParseCase
          )
          writeToFile(
          ...
          if (
            ...
            const globalClassNameKeys = extractClassNameKeys(
              (0, import_postcss_js.objectify)(
                (0, import_postcss.parse)(css.globalStyle)
              ),
              toParseCase
            )
            writeToFile(
